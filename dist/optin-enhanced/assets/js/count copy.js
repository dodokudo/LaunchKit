var cookie_name = 'T5vJP2yRYmPq'; // クッキー名
...
function get_firstaccess(){
    ...
    if (!first){
        ...
        $.cookie(cookie_name, first, {expires: 90, path:'/'});
    }
...
$(function(){
	...
	first = ($.cookie(cookie_first));

    console.dir(first);
		
	limit = new Date(parseInt(first) + limit_days*24*60*60*1000 + 9*60*60*1000 );
	limit = new Date(limit - limit % (24*60*60*1000) -3*60*60*1000 );
